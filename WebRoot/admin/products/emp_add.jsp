...
<body>
	<form id="userAction_save_do" name="Form1"
		action="${pageContext.request.contextPath}/emp_addEmp.action"
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="emp.emp_id" class="bg" /></td>
			</tr>
			<tr>
				<td align="center" bgColor="#f5fafe" class="ta_01">姓名：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="emp.emp_name" class="bg" /></td>
			</tr>
			<tr>
				<td align="center" bgColor="#f5fafe" class="ta_01">性别：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="radio"
					name="emp.emp_gender" checked="checked" value="男" />男 <input
					type="radio" name="emp.emp_gender" value="女" />女</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><select name="emp.emp_age">
						<option value="--请选择--">--请选择--</option>
						<option value="20">20</option>
						<option value="21">21</option>
						<option value="22">22</option>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="emp.emp_address" class="bg" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><select
					name="emp.emp_fk_pos_id" id="posSelect">
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="emp.emp_phone" class="bg" /></td>
			</tr>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><img id="img"><br>
					<input type="file" name="emppic" class="bg" /></td>
			</tr>
